...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C1_SCL_MAX30102_GPIO_Port, I2C1_SCL_MAX30102_Pin);

    HAL_GPIO_DeInit(I2C1_SDA_MAX30102_GPIO_Port, I2C1_SDA_MAX30102_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB3     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(I2C2_SCL_BME280_GPIO_Port, I2C2_SCL_BME280_Pin);

    HAL_GPIO_DeInit(I2C2_SDA_BME280_GPIO_Port, I2C2_SDA_BME280_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PB4     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(I2C3_SCL_LCD_GPIO_Port, I2C3_SCL_LCD_Pin);

    HAL_GPIO_DeInit(I2C3_SDA_LCD_GPIO_Port, I2C3_SDA_LCD_Pin);
